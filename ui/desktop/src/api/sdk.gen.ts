...
export const getMcpSkillServers = <ThrowOnError extends boolean = false>(options: Options<GetMcpSkillServersData, ThrowOnError>) => (options.client ?? client).get<GetMcpSkillServersResponses, unknown, ThrowOnError>({ url: '/config/mcp_skill_servers', ...options });

export const setExtensionSkillsEnabled = <ThrowOnError extends boolean = false>(options: Options<SetExtensionSkillsEnabledData, ThrowOnError>) => (options.client ?? client).post<SetExtensionSkillsEnabledResponses, SetExtensionSkillsEnabledErrors, ThrowOnError>({
