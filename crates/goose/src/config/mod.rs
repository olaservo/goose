...
pub use extensions::{
    ...
    get_extension_by_name, get_warnings, is_extension_enabled, is_skills_enabled, remove_extension,
    resolve_extensions_for_new_session, set_extension, set_extension_enabled,
    set_extension_skills_enabled, ExtensionEntry,
};
