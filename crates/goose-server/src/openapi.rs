...
#[openapi(
    paths(
        ...
        super::routes::config_management::get_mcp_skill_servers,
        super::routes::config_management::set_extension_skills_enabled,
    ...
    components(schemas(
        ...
        super::routes::config_management::SetSkillsEnabledRequest,
        goose::agents::extension_manager::McpSkillServerSummary,
